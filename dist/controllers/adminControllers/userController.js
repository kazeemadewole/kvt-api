    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                console.log("found!!!");
                token = jsonwebtoken_1.default.sign({ _id: user._id.toString(), role: user.role }, "RANDOM_TOKEN_SECRET", {
                    expiresIn: "24h",
                });
            ...
            case 4: return [2 /*return*/, next(new appError_1.default(" can't to login!", 401))];
            case 5: return [2 /*return*/, next(new appError_1.default("Unable to login!", 401))];
        }
    });
}); });
